...
*/
metadata {
                definition (name: "Aeon Multisensor Gen5 Battery Settings - Fixed", namespace: "Aeotec", author: "Chris Cheng") {
...
def configureAfterSecure() {
	...
	cmds << zwave.configurationV1.configurationSet(parameterNumber: 4, size: 1, scaledConfigurationValue: 1) //1 = enabled??
    // disable notification-style motion events
	cmds << zwave.notificationV3.notificationSet(notificationType: 7, notificationStatus: 1) // changed from 0
